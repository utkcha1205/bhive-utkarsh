...
const Workspaces= () => {
  ...
  return (
    <div className=" px-0 md:mx-4 lg:mx-4  xl:mx-4">
      ...
      {data.map((card, index) => (
        <div key={index} className="p-4 rounded-lg shadow-md border bg-white  flex flex-col justify-between">
          {/* Header Section */}
          <div className="mb-4">
            <div className="flex justify-between items-center">
              ...
              <a  
                ...
                className="cursor-pointer size-[52px] rounded-md bg-secondaryGrey flex flex-col justify-center items-center border-[0.5px] border-solid border-lightgray">
                <DirectionSVG/>
          ...
          <div className="relative">
            ...
            />
            <div className="absolute top-2 left-2 bg-primaryText flex items-center text-white text-xs px-2 py-1 rounded">
              <img src={card.icon}
            alt={card.name} className="size-4 mr-1" />
              <span>{card.type}</span>
            </div>
